...
#ifndef OTLS_CABLEFILECONVERTER_CABLEFILEXMLHANDLER_H_
#define OTLS_CABLEFILECONVERTER_CABLEFILEXMLHANDLER_H_
...
/// \par OVERVIEW
///
/// This class parses and generates a cable file XML node. The data is
...
class CableFileXmlHandler : public XmlHandler {
 public:
  ...
  /// \brief Parses an XML node and populates a cable.
  /// \param[in] root
...
#endif  // OTLS_CABLEFILECONVERTER_CABLEFILEXMLHANDLER_H_
